// Torklio — modules/appointments-v2.js
// Appointments Scheduler v2: adds a Daily Shop Workflow Board (Shopmonkey-
// style stage columns, structural inspiration only) alongside the existing
// time-grid Calendar view. Built side-by-side with modules/appointments.js
// (untouched) — same real data sources (db.jobs/db.bookings/db.employees/
// db.bays/db.settings) through the same util.* RO/booking transitions.
...
// Entry point
// ---------------------------------------------------------------------------
export function renderAppointmentsV2() {
  try {
    renderNav('#icon-rail', 'appointments-v2.html');
    ...
    console.error('Error in renderAppointmentsV2:', e);
