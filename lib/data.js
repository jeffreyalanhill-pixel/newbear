...
function seed() {
  ...
  // ---- Employees (Part A minimal shape; techs = isTech:true) ----
  const employees = [
    { id: 't_marcus', firstName: 'Marcus', lastName: 'Johnson', avatar: 'MJ', isTech: true, bayId: 'b_3', role: 'technician', payType: 'flat_rate', payRate: 32, clockStatus: 'in', workStatus: 'working' },
    { id: 't_devon', firstName: 'Devon', lastName: 'Carter', avatar: 'DC', isTech: true, bayId: 'b_1', role: 'technician', payType: 'flat_rate', payRate: 30, clockStatus: 'in', workStatus: 'working' },
    { id: 't_chris', firstName: 'Chris', lastName: 'Bell', avatar: 'CB', isTech: true, bayId: 'b_4', role: 'technician', payType: 'hourly', payRate: 26, clockStatus: 'in', workStatus: 'idle' },
    { id: 't_tyler', firstName: 'Tyler', lastName: 'Nguyen', avatar: 'TN', isTech: true, bayId: 'b_2', role: 'technician', payType: 'hourly', payRate: 24, clockStatus: 'in', workStatus: 'waiting' },
    { id: 'e_sara', firstName: 'Sara', lastName: 'Diaz', avatar: 'SD', isTech: false, role: 'advisor', payType: 'hourly', payRate: 24, clockStatus: 'in', workStatus: 'working' },
    { id: 'e_jeff', firstName: 'Jeff', lastName: 'Hill', avatar: 'JH', isTech: false, role: 'owner', payType: 'salary', payRate: 95000, clockStatus: 'in', workStatus: 'working' },
  ];
  ...
  const customers = [
    ...
    { id: 'c_linda', firstName: 'Linda', lastName: 'P.', phone: '555-201-1009', email: 'linda.p@example.com', createdAt: daysAgoISO(200) },
