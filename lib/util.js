...
const MODULE_ACCESS_BY_ROLE = {
  ...
  service_manager: { Dashboard: 'limited', Booking: 'none', Appointments: 'read_only', CRM: 'none', Quotes: 'limited', 'Digital Inspections': 'full', 'Repair Orders': 'full', 'Live Monitor': 'full', Invoices: 'none', POS: 'none', Inventory: 'limited', Marketing: 'none', Team: 'limited', Schedule: 'full', 'PTO / Time Off': 'limited', 'Time Clock': 'full', Reports: 'limited', Settings: 'none', 'Billing/Subscription': 'none', Integrations: 'none', 'Data Export': 'none' },
