...
util.createQuoteFromRecommended = (roId, itemNames) => {
  ...
  workflow.recordWorkflowEvent('quote', quote.id, 'quote_created', `${quote.quoteNumber} created from ${ro.ro} inspection findings`, { customerId: ro.customerId, roId: ro.id, quoteId: quote.id });
  return quote;
};
