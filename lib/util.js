...
util.addShift = (employeeId, data) => {
  ...
  const shift = {
    id: db.nextId('shift'), employeeId, date: data.date, start: data.start, end: data.end,
    note: data.note || '', published: true, bayId: data.bayId || null, roleForShift: data.roleForShift || '',
    status: 'scheduled',
  };
  shifts.push(shift);
...
const MODULE_LIST = ['Dashboard', 'Appointments', 'CRM', 'Quotes', 'Repair Orders', 'Invoices', 'POS', 'Inventory', 'Marketing', 'Team', 'Reports', 'Settings', 'Billing/Subscription'];
const MODULE_ACCESS_BY_ROLE = {
  owner: Object.fromEntries(MODULE_LIST.map((m) => [m, 'full'])),
  manager: Object.fromEntries(MODULE_LIST.map((m) => [m, m === 'Billing/Subscription' ? 'read_only' : 'full'])),
  advisor: { Dashboard: 'limited', Appointments: 'full', CRM: 'full', Quotes: 'full', 'Repair Orders': 'full', Invoices: 'full', POS: 'limited', Inventory: 'read_only', Marketing: 'none', Team: 'none', Reports: 'limited', Settings: 'none', 'Billing/Subscription': 'none' },
  technician: { Dashboard: 'limited', Appointments: 'read_only', CRM: 'none', Quotes: 'none', 'Repair Orders': 'limited', Invoices: 'none', POS: 'none', Inventory: 'read_only', Marketing: 'none', Team: 'none', Reports: 'none', Settings: 'none', 'Billing/Subscription': 'none' },
  apprentice: { Dashboard: 'limited', Appointments: 'read_only', CRM: 'none', Quotes: 'none', 'Repair Orders': 'read_only', Invoices: 'none', POS: 'none', Inventory: 'read_only', Marketing: 'none', Team: 'none', Reports: 'none', Settings: 'none', 'Billing/Subscription': 'none' },
};
